...
HD_PWD='C:/FPGA_Verilog_work/Project/Example_1/Example_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_invert.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_invert.tcl

...
HD_PWD='C:/FPGA_Verilog_work/Project/Example_1/Example_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_invert.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit_invert.tcl -notrace

...
HD_PWD='C:/FPGA_Verilog_work/Project/Example_3/Example_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_full_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_full_adder.tcl

...
HD_PWD='C:/FPGA_Verilog_work/Project/Example_3/Example_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_full_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit_full_adder.tcl -notrace

...
HD_PWD='C:/FPGA_Verilog_work/Project/Example_2/Example_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_half_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit_half_adder.tcl -notrace

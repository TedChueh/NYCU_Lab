...
HD_PWD='C:/FPGA_Verilog_work/Project/Example_2/Example_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_half_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_half_adder.tcl
